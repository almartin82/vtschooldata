...
## ----statewide-chart, fig.cap="Vermont statewide enrollment has declined steadily since 2004"----
...
## ----top-districts-chart, fig.cap="Top 10 Vermont supervisory unions by enrollment"----
top_districts %>%
...
## ----demographics-chart, fig.cap="Enrollment by grade level in Vermont"-------
grade_dist %>%
...
## ----regional-chart, fig.cap="Enrollment trends for top Vermont SUs"----------
...
## ----growth-chart, fig.cap="Distribution of supervisory union sizes in Vermont"----
