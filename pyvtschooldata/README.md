...
Python wrapper for Vermont school enrollment data.

This is a thin rpy2 wrapper around the [vtschooldata](https://github.com/almartin82/vtschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `vtschooldata` R package installed
...
# In R:
# remotes::install_github("almartin82/vtschooldata")

# Then install the Python package
pip install pyvtschooldata
```
...
# Fetch one year
df = vt.fetch_enr(2025)

# Fetch multiple years
df_multi = vt.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
